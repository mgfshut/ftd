...
public class PackageData implements Serializable {
    ...
    public String toString() {
        return "PackageData [msgHeader=" + msgHeader + ", msgBodyBytes=" + Arrays.toString(msgBodyBytes) + ", checkSum="
                + checkSum +", calculatedCheckSum=" + calculatedCheckSum + ", address=" + channel + "]";
    }
    ...
    public static class MsgHeader implements Serializable {
        ...
        public void setTotalSubPackage(int totalPackage) {
        ...
        public void setSubPackageSeq(int packageSeq) {
