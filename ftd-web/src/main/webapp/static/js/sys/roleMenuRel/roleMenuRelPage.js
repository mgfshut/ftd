var url=path+"/roleMenuRel/queryPageList";
var totalurl=path+"/roleMenuRel/queryByCount";
var deleteurl = path+"/roleMenuRel/batchDelete";
var viewDetail = path+"/roleMenuRel/view"
//初始化分页
$(function(){
