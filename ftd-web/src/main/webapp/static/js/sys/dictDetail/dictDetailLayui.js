...
layui.use('layer', function(){ //独立版的layer无需执行这一句
    ...
    var active = {
        //添加弹窗
        notice: function(){
            var dictDefineId = $("#dictDefineId").val();
            //示范一个公告层
            if(dictDefineId != undefined && dictDefineId != ""){
                //示范一个公告层
                layer.open({
                    type: 2
                    ,title: "添加参数明细" //不显示标题栏
                    ...
                    ,content: path+'/dictDetail/add?dictDefineId='+dictDefineId
                });
            }
        }
        //修改弹窗
        ,notice2: function(){
            ...
            if(id != undefined){
                layer.open({
                    ...
                    ,id: 'LAY_layuipro' //设定一个id，防止重复弹出
                    ,moveType: 1 //拖拽模式，0或者1
                    ,content:path+'/dictDetail/add?id='+id
