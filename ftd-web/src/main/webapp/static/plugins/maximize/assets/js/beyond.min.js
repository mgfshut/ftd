...
function InitiateWidgets() {
	...
	function(n) {
		...
		r = "fa-compress",
		u = "fa-expand";
		t.hasClass("maximized") ? (i && i.addClass(u).removeClass(r), t.removeClass("maximized"), t.find(".widget-body").css("height", "170px")) : (i && i.addClass(r).removeClass(u), t.addClass("maximized"), maximize(t))
	});
...
function maximize(n) {
	if (n) {
        ...
        n.find(".widget-body.line-title").height(t - i - 35)
	}
}
