    ...
    <body>
        <form class="layui-form" action="" id="tableFrom">
            <div class="index_serach">
                <span class="index_serachSpan">系统参数名称</span>
                <div class="layui-input-inline index_serachSelect">
                    <input type="" name="dictDefineName" lay-verify="" autocomplete="off" class="layui-input">
                </div>
                <span class="index_serachSpan">系统参数描述</span>
                <div class="layui-input-inline index_serachSelect">
                    <input type="" name="dictDefineDescribe" lay-verify="" autocomplete="off" class="layui-input">
                </div>
                <%--<span class="index_serachSpan">数据字典状态</span>
                <div class="layui-form layui-input-inline index_serachSelect">
                    <select name="dictDefineStatus">
        ...
        <script type="text/javascript" src="<%=path%>/static/js/sys/dictDefine/dictDefinePage.js" ></script>
    </body>
</html>