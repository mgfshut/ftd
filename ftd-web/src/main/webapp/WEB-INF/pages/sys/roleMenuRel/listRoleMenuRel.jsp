    ...
    <body>
        <form class="layui-form" action="" id="tableFrom">
            <div class="index_serachT">
                ...
                <span class="index_serachSpan">菜单ID</span>
                <div class="layui-input-inline index_serachSelect">
                    <input type="" name="menuId" lay-verify="" autocomplete="off" class="layui-input">
                </div>
                <br/>
        ...
        <script type="text/javascript" src="<%=path%>/static/js/sys/roleMenuRel/roleMenuRelPage.js" ></script>
    </body>
</html>