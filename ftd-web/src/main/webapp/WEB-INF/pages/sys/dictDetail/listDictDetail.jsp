...
<html lang="en">
    ...
    <body>
        <form class="layui-form" action="" id="tableFrom">
            <input type="hidden" id="dictDefineId" name="dictDefineId" autocomplete="off" class="layui-input" value="${dictDefineId}">
            <div class="index_serach">
                <span class="index_serachSpan">参数明细名称</span>
                <div class="layui-input-inline index_serachSelect">
                    <input type="" name="dictDetailName" lay-verify="" autocomplete="off" class="layui-input">
                </div>
                <span class="index_serachSpan">参数明细状态</span>
                <div class="layui-form layui-input-inline index_serachSelect">
                    <select name="dictDetailStatus">
        ...
        <script type="text/javascript" src="<%=path%>/static/js/sys/dictDetail/dictDetailPage.js" ></script>
    </body>
</html>