...
<html lang="en">
    ...
    <body>
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="userId" value="${item.userId}" lay-verify="" class="layui-input" />
                        </div>
                    </div>
                    <div class="layui-inline">
        ...
        <script type="text/javascript" src="<%=path%>/static/js/sys/userRoleRel/userRoleRel.js" ></script>
